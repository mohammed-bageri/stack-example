...
export const PostCreateNestedManyWithoutCategoriesInputSchema: z.ZodType<Prisma.PostCreateNestedManyWithoutCategoriesInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => PostCreateWithoutCategoriesInputSchema),
          z.lazy(() => PostCreateWithoutCategoriesInputSchema).array(),
          z.lazy(() => PostUncheckedCreateWithoutCategoriesInputSchema),
          z.lazy(() => PostUncheckedCreateWithoutCategoriesInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => PostCreateOrConnectWithoutCategoriesInputSchema),
          z.lazy(() => PostCreateOrConnectWithoutCategoriesInputSchema).array(),
        ])
        .optional(),
      connect: z
        .union([
...
export const PostUpdateManyWithoutCategoriesNestedInputSchema: z.ZodType<Prisma.PostUpdateManyWithoutCategoriesNestedInput> =
  z
    .object({
      ...
      upsert: z
        .union([
          z.lazy(() => PostUpsertWithWhereUniqueWithoutCategoriesInputSchema),
          z
            .lazy(() => PostUpsertWithWhereUniqueWithoutCategoriesInputSchema)
            .array(),
        ])
        .optional(),
      set: z
      ...
      update: z
        .union([
          z.lazy(() => PostUpdateWithWhereUniqueWithoutCategoriesInputSchema),
          z
            .lazy(() => PostUpdateWithWhereUniqueWithoutCategoriesInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => PostUpdateManyWithWhereWithoutCategoriesInputSchema),
          z
            .lazy(() => PostUpdateManyWithWhereWithoutCategoriesInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export const CategoryCreateNestedManyWithoutPostsInputSchema: z.ZodType<Prisma.CategoryCreateNestedManyWithoutPostsInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => CategoryCreateWithoutPostsInputSchema),
          z.lazy(() => CategoryCreateWithoutPostsInputSchema).array(),
          z.lazy(() => CategoryUncheckedCreateWithoutPostsInputSchema),
          z.lazy(() => CategoryUncheckedCreateWithoutPostsInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => CategoryCreateOrConnectWithoutPostsInputSchema),
          z.lazy(() => CategoryCreateOrConnectWithoutPostsInputSchema).array(),
        ])
        .optional(),
      connect: z
        .union([
...
export const CategoryUpdateManyWithoutPostsNestedInputSchema: z.ZodType<Prisma.CategoryUpdateManyWithoutPostsNestedInput> =
  z
    .object({
      ...
      upsert: z
        .union([
          z.lazy(() => CategoryUpsertWithWhereUniqueWithoutPostsInputSchema),
          z
            .lazy(() => CategoryUpsertWithWhereUniqueWithoutPostsInputSchema)
            .array(),
        ])
        .optional(),
      set: z
      ...
      update: z
        .union([
          z.lazy(() => CategoryUpdateWithWhereUniqueWithoutPostsInputSchema),
          z
            .lazy(() => CategoryUpdateWithWhereUniqueWithoutPostsInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => CategoryUpdateManyWithWhereWithoutPostsInputSchema),
          z
            .lazy(() => CategoryUpdateManyWithWhereWithoutPostsInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export const PostUpsertWithWhereUniqueWithoutCategoriesInputSchema: z.ZodType<Prisma.PostUpsertWithWhereUniqueWithoutCategoriesInput> =
  z
    .object({
      where: z.lazy(() => PostWhereUniqueInputSchema),
      update: z.union([
        z.lazy(() => PostUpdateWithoutCategoriesInputSchema),
...
export const CategoryUpsertWithWhereUniqueWithoutPostsInputSchema: z.ZodType<Prisma.CategoryUpsertWithWhereUniqueWithoutPostsInput> =
  z
    .object({
      where: z.lazy(() => CategoryWhereUniqueInputSchema),
      update: z.union([
        z.lazy(() => CategoryUpdateWithoutPostsInputSchema),
